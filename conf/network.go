...
func setLog() {
	...
	var cfg = map[string]interface{}{
		//保存的文件名
		"filename": common.LogPath + beego.AppConfig.String("log_filename"),
...
/*
日志级别，从低到高。示例代码：
beego.Debug("beego test debug logself")
beego.Info("beego test info logself")
beego.Notice("beego test notice logself")
beego.Warning("beego test warning logself")
beego.Error("beego test error logself")
beego.Critical("beego test critical logself")
beego.Alert("beego test alert logself")
beego.Emergency("beego test emergency logself")
*/
